...
class HistorialRepository:
    """Repositorio para gestionar historiales clínicos en la base de datos"""
    ...
    def get_by_id(self, historial_id: int) -> Optional[HistorialClinico]:
        """
    ...
    def get_by_mascota(self, mascota_id: int) -> List[HistorialClinico]:
        """
    ...
    def create(self, historial_data: Dict[str, Any]) -> HistorialClinico:
        """
    ...
    def update(self, historial_id: int, historial_data: Dict[str, Any]) -> HistorialClinico:
        """
